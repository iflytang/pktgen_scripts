...
# # flow_C, used for benchmark, figure 15 (a), scenario 1: 64B, 0.672 Mpps, adjust sampling rate; OR for figure 18 (a)
...
do
    trace_array[$trace_index]=${trace_line}*10    # in percentage
